...
<body>
    ...
    <nav>
        <ul>
                ...
                <li><a href="adverts.php" >International</a></li>
                <li>
                <form action="search.php" method="post">  
                <input type="text" name="query" class="search-btn" size="25px" > <input type="submit" id="search" name="search" value=Search>
                </form>
                </li>
    ...
    <section>
        ...
        <div class="slideshow-container">
            ...
            <img src="resources/pic/index.jpeg" width="100%" height="400px" >
            ...
            <img src="resources/pic/images2.jpeg" width="100%" height="400px">
...
<?php
     require_once("connect.php");
     // Load comments into a database
     if(isset($_POST['submit'])){
         if($_POST['name'] == '' or $_POST['comment'] == '' or $_POST['email'] == ''){
             ...
             if(mysql_query("INSERT INTO comments (name,comment,email,post_id) VALUES ('{$name}','{$comment}','{$email}','{$id}')")){
 
                 echo '<script>alert("comment was successfully posted!!!")</script>';
                 exit();
                }
                else{
                 echo '<script>alert("comment was Unsuccessfully!!! ")</script>';
             }
         }
    }
